                    ...
                    value: function(srcType, imageSrc, done) {
                        ...
                        inMemoryImage.onerror = function(errorEvent) {
                            ...
                            _this12.imageCache[imageSrc] = {
                                ...
                                maxWidth: _this12.naturalWidth / dvp,
                                maxHeight: _this12.naturalHeight / dvp
                            }, done();
                        ...
                        var images = [], addImage = function(srcType, imageClass, transforms) {
                            ...
                            if (_this16.props[srcType]) {
                                ...
                                if (zoomLevel > _constant.MIN_ZOOM_LEVEL && (imageStyle.cursor = "move"), null === bestImageInfo) {
                                    ...
                                    keyEndings[srcType];
                                    return _this16.imageCache[imageSrc] && (imageStyle.maxWidth = _this16.imageCache[imageSrc].maxWidth, 
                                    imageStyle.maxHeight = _this16.imageCache[imageSrc].maxHeight), void images.push(_react2.default.createElement("div", {
