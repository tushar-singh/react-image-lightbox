    ...
    function(module, exports, __webpack_require__) {
        ...
        var ReactImageLightbox = function(_Component) {
            function ReactImageLightbox(props) {
                ...
                return _this.__images = {}, _this.state = {
                    //-----------------------------
                    // Animation
                    //-----------------------------
                    // Lightbox is closing
                ...
                value: function() {
                    ...
                    var images = [], addImage = function(srcType, imageClass) {
                        ...
                        if (_this14.props[srcType]) {
                            ...
                            if (discourageDownloads) imageStyle.backgroundImage = "url('" + imageSrc + "')", 
                            images.push(_react2.default.createElement("div", {
                                ...
                                imageSrc + keyEndings[srcType];
                                console.log(_this14.imageCache), _this14.imageCache[imageSrc] && (imageStyle.maxWidth = _this14.imageCache[imageSrc].maxWidth, 
                                imageStyle.maxHeight = _this14.imageCache[imageSrc].maxHeight), images.push(_react2.default.createElement("img", {
